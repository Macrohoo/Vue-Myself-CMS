  ...
  <div class="gallery-contain flex justify-around align-center">
          ...
          <div v-for="(item, index) in this.$store.getters.groups" :key="index">
            ...
            >
              ...
              <div class="flex align-center justify-between" style="width: 78px">
                ...
                <el-popover v-model="item.cancelVisible" placement="top" width="160">
                  <p>警告:确定删除素材分组?</p>
    ...
    <div class="right flex flex-direction">
      ...
      <div class="right-tool flex flex-shrink-0 justify-start align-center">
        <el-popover v-model="repeatVisible" placement="top" width="160">
          <p>警告:确定删除?</p>
          <div style="text-align: right; margin: 0">
        ...
        <OMDialog title="新建子分组" style="margin: 0px 10px" :parent_id="parentIdNeeded" @confirm="handlePostGroup">
          <el-button v-show="currentIndex !== -1" size="small" class="yael-button">新建子分组</el-button>
        </OMDialog>
        <el-button
      ...
      <div v-if="currentIndex === -1" class="right-contain flex flex-grow-1 flex-direction justify-between">
        ...
        <div class="right-contain-pv flex flex-wrap">
          <div v-for="(item, index) in this.$store.getters.containMaterials" :key="index">
            <ya-checkbox
              :options="item"
              :select-data="selectMaterials"
              :link-src="item.type === '1' ? item.url : item.thumbnail"
              :src-width="64"
              :src-height="64"
              :width="104"
              :height="104"
