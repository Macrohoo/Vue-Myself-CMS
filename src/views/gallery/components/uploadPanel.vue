<template>
  <div>
    <div class="panel">
      <el-tabs v-model="activeMaterial" type="border-card" stretch>
        <el-tab-pane label="图片上传" name="pic" class="panel-son flex flex-direction justify-around">
          <div class="panel-son-top flex justify-around">
            <el-switch v-model="multiple" active-text="批量上传" inactive-text="单个上传" />
          ...
          <div class="panel-son-bottom flex flex-direction justify-around align-center">
            <div class="piclist flex flex-wrap justify-center" style="height: 26vh; width: 100%; overflow: scroll;">
              ...
              />
              <svg-icon v-show="fulfill" icon-class="wancheng" style="width:200px; height: 200px" />
              <div
            ...
            <ya-upload
              :action="uploadNow"
              :after-upload="uploadAfter"
              :btn_words="multiple ? (needCanvas ? '批量选择' : '批量上传') : '单个上传'"
              size="mini"
              :auto-upload="true"
              :need-canvas="needCanvas"
              :fields="value"
              :multiple="multiple"
